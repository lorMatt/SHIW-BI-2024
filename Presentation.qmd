...
-   **reddito** (lordo/netto; giornaliero/settimanale/annuale/nella vita; da quali fonti?)
-   **ricchezza** \[tutto ciò che un individuo possiede… ovvero? E i debiti/mutui?\]
-   **consumo/spesa**

## Unità di analisi

**Individuo**, **coppia**, **conviventi**, **famiglia** (nucleare o allargata)?

Ciascuna scelta implica assunzioni su condivisione e redistribuzione delle risorse. Se la famiglia è l'unità di aggregazione, occorre scegliere se pesare per individui o per famiglie.

-   **Scale di equivalenza** Aggiustano il reddito familiare per il numero di componenti. Principali: scala OCSE modificata (1 / 0,5 / 0,3) e radice quadrata dei componenti. Per la ricchezza si usa spesso il pro capite.

## **Proprietà desiderabili delle misure di disuguaglianza - 1**

-   **Simmetria**

-   **Indipendenza dalla scala** e dalla dimensione della popolazione

-   **Decomponibilità per sottogruppi**

## **Proprietà desiderabili delle misure di disuguaglianza - 2**

-   **Principio dei trasferimenti**

    -   **Debole** (Pigou-Dalton) - un trasferimento progressivo riduce la disuguaglianza

    -   **Forte** (Cowell) - la diminuzione delle disuguaglianze dovuta al trasferimento dipende dalla distanza nei redditi dei due individui che prendono parte alla transazione

-   **Sensibilità** ai trasferimenti nella **parte bassa della distribuzione** (Atkinson)

## **Principali misure di disuguaglianza - 1**

-   **Rapporti tra percentili/quote**: es. Q90/Q50, S80/S20 — semplici ma limitati

-   **Coefficiente di variazione**: $$\frac{\sqrt{σ^2}}
    {ȳ}$$ — decomponibile, distanze assolute

## Principali misure **di disuguaglianza** - 2

-   **Indice di Gini**: 0–1, basato sulla curva di Lorenz, non decomponibile, sensibile alla parte centrale della distribuzione

-   **Entropia generalizzata (Eθ)**: famiglia parametrica, decomponibile; casi speciali: MLD (θ=0), indice di Theil (θ=1), metà CV² (θ=2). Al diminuire di θ, maggiore sensibilità alla parte bassa $$ E_\theta = \frac{1}{\theta^2 - \theta} \left[ \frac{1}{n} \sum_{i=1}^{n} \left( \frac{y_i}{\bar{y}} \right)^\theta - 1 \right]$$

## Curva di Lorenz e indice di Gini

::::: columns
::: {.column width="50%"}
![](images/clipboard-2881284955.png){width="609"}
:::
...
-   Approcci **soggettivi**/**oggettivi**

-   Assoluta (paniere fisso aggiornato per inflazione) vs. relativa (es. 60% del reddito mediano). Indicatori: tasso di incidenza, rischio relativo, gap di povertà.
...
$$
\frac{
\text{Numero di persone in condizioni di povertà}
}{
...
**Intensità della povertà** (gap \* tasso)

$$
\text{Tasso di povertà} \times
\frac{
(\text{soglia di povertà} - \text{reddito povero medio})}
{
\text{soglia di povertà}}
...
# Investigare i fattori di rischio della povertà
